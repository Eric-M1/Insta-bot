...
banner() {
printf " \n"
printf " \e[1;31m[\e[0m\e[1;77m::\e[0m\e[1;31m]\e[0m\e[1;93m All account passwords are saved on your phone\e[0m (.txt)\n" 
printf " \e[1;31m[\e[0m\e[1;77m::\e[0m\e[1;31m]\e[0m\e[1;93m Telegrams of the code author:\e[0m FELIX4\n"
printf " \e[1;31m[\e[0m\e[1;77m::\e[0m\e[1;31m]\e[0m\e[1;93m Instagram-bot\e[0m v2.7.3\n" 
#printf " \e[1;31m[\e[0m\e[1;77m::\e[0m\e[1;31m]\e[0m\e[1;93m --\e[0m\n"
}
...
#Защита от бана. При показе "Error" если не хотетите остановить процесс, то удалите этот код ↓↓↓
...
#Защита от бана. При показе "Error, stoping to prevent blocking" если не хотите оставить процесс, то удалите этот код ↓↓↓
if [[ $check_unfollow == "" ]]; then
